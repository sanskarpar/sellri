    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center gap-6">
          ...
          {(instagram || whatsapp || facebook || phone || email || address) && (
            <div className="flex items-center gap-3">
              {instagram && (
                ...
                >
                  <svg className={`w-5 h-5 transition-colors ${hasBg ? "text-white/80 group-hover:text-white" : "text-slate-500 group-hover:text-slate-700"}`} fill="currentColor" viewBox="0 0 24 24">
              ...
              {whatsapp && (
                ...
                >
                  <svg className={`w-5 h-5 transition-colors ${hasBg ? "text-white/80 group-hover:text-[#25D366]" : "text-slate-500 group-hover:text-[#25D366]"}`} fill="currentColor" viewBox="0 0 24 24">
              ...
              {facebook && (
                ...
                >
                  <svg className={`w-5 h-5 transition-colors ${hasBg ? "text-white/80 group-hover:text-[#1877F2]" : "text-slate-500 group-hover:text-[#1877F2]"}`} fill="currentColor" viewBox="0 0 24 24">
              ...
              {phone && (
                <a href={`tel:${phone}`} className={`w-11 h-11 rounded-full transition-all duration-300 flex items-center justify-center group ${hasBg ? "bg-white/10 hover:bg-white/20" : "bg-slate-100 hover:bg-slate-200"}`}>
                  <svg className={`w-5 h-5 transition-colors ${hasBg ? "text-white/80 group-hover:text-white" : "text-slate-500 group-hover:text-slate-700"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
              {policies.map((p) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`text-xs transition-colors duration-300 underline underline-offset-2 ${hasBg ? "text-white/50 hover:text-white/80" : "text-slate-400 hover:text-slate-600"}`}
                >
                  {p.label}
                </a>
              ))}
          ...
          {copyright && (
            <p className={`text-sm transition-colors duration-300 ${hasBg ? "text-white/40 hover:text-white/60" : "text-slate-400 hover:text-slate-500"}`}>
              {copyright}
            </p>
          )}
        </div>
